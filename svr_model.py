...
yolov6_model = my_yolov6("weights/yolov6s_n.pt","cpu","data/mydataset.yaml", 640, True)
# yolov6_model = my_yolov6("weights/fire_detect.pt","cpu","data/mydataset.yaml",         640, True)
